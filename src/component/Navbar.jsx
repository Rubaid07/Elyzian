...
export default function Navbar() {
  ...
  return (
    <nav className="bg-blue-50/90 border-b border-gray-200 sticky top-0 z-50">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              {user && (
                <div className="dropdown dropdown-end">
                  ...
                  <ul
                    tabIndex={0}
                    className="menu menu-sm dropdown-content mt-3 p-2 shadow bg-blue-50 rounded-box w-56 font-semibold"
                  >
                    <li>
